...
const CYBLE_CUSTOMS_T cyBle_customs[0x02u] = {
    ...
    /* DHT22 service */
    {
        0x0010u, /* Handle of the DHT22 service */ 
        {

            /* Humidity characteristic */
            {
                0x0012u, /* Handle of the Humidity characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0013u, /* Handle of the Humiditycccd descriptor */ 
            ...
            {
                0x0016u, /* Handle of the Temperature characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x0017u, /* Handle of the Temperaturecccd descriptor */ 
    ...
    /* Prox_Sensor service */
    {
        0x0019u, /* Handle of the Prox_Sensor service */ 
        {

            /* Proximity characteristic */
            {
                0x001Bu, /* Handle of the Proximity characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x001Cu, /* Handle of the Proximitycccd descriptor */ 
