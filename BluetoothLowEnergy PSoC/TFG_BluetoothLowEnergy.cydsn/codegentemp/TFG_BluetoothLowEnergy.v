// ======================================================================
// TFG_BluetoothLowEnergy.v generated from TopDesign.cysch
// 03/07/2020 at 13:29
...
module CapSense_CSD_P4_v2_60_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("383fca1c-a50a-4bec-b1ce-741115a5eff7/899719c0-e797-4403-a44f-07a66de2cbeb"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("383fca1c-a50a-4bec-b1ce-741115a5eff7/73b612cd-240c-4d8e-8340-ea28aabf4b11"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
    ...
    CapSense_CSD_P4_v2_60_1 CapSense ();
